...
void Game::Init()
{
	...
	// Load levels
	GameLevel one; one.Load("levels/01.lvl", this->Width, this->Height * 0.5);
	GameLevel two; two.Load("levels/02.lvl", this->Width, this->Height * 0.5);
	GameLevel three; three.Load("levels/03.lvl", this->Width, this->Height * 0.5);
	GameLevel four; four.Load("levels/04.lvl", this->Width, this->Height * 0.5);
...
void Game::Render()
{
	...
	std::stringstream fpsSS; fpsSS << this->FPS;
	Text->RenderText("FPS: " + fpsSS.str(), 5.0f, 30.0f, 1.0f);
}


void Game::ResetLevel()
{
	if (this->Level == 0)this->Levels[0].Load("levels/01.lvl", this->Width, this->Height * 0.5f);
	else if (this->Level == 1)
		this->Levels[1].Load("levels/02.lvl", this->Width, this->Height * 0.5f);
	else if (this->Level == 2)
		this->Levels[2].Load("levels/03.lvl", this->Width, this->Height * 0.5f);
	else if (this->Level == 3)
		this->Levels[3].Load("levels/04.lvl", this->Width, this->Height * 0.5f);
